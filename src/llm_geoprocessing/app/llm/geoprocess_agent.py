...
def complete_json(chatbot: Chatbot, user_message: str) -> Dict[str, Any]:
    ...
    """
    summary_instructions = "Summarize the following messages exchanged so far, focusing on geoprocessing tasks and data details. Keep it concise in each bullet, but make all the bullets you need."
    ...
    summary_instructions += "- Unwanted details: <list of things that the user wants to avoid>\n"
    summary_instructions += "- Desired details: <list of things that the user wants to include>\n"
    summary_instructions += "- Previous attempts: <list of previous attempts and their issues>\n"
    summary_instructions += "- Important context: <any other relevant context with the updated information>\n"
