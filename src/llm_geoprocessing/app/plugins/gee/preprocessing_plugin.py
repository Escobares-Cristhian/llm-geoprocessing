def get_metadata_preprocessing() -> str:
    ...
    return (
        ...
        "- MODIS/061/MOD11A1: MODIS Terra Land Surface Temperature & Emissivity\n"
        "- MODIS/061/MYD11A1: MODIS Aqua Land Surface Temperature & Emissivity\n"
        "NOTES on products:\n"
...
def get_documentation_preprocessing() -> str:
    ...
    return (
        ...
        "• MODIS/061/MOD11A1 (Terra) & MODIS/061/MYD11A1 (Aqua): "
        "LST_Day_1km, LST_Night_1km, QC_Day, QC_Night, Emis_31, Emis_32. Units: Kelvin (scale 0.02).\n"
        "\n\n\n"
        "Available projections in GEE: <GEE CRS>: <Description and usual names>\n"
        "- EPSG:4326: WGS 84 (lat/lon, WGS84, or similar)\n"
        "- EPSG:3857: Web Mercator (Google Maps, OSM)\n"
        "- EPSG:326XX / EPSG:327XX: UTM zones (XX = zone number, 6 for northern hemisphere, 7 for southern hemisphere). Example: EPSG:32606 for UTM zone 6N., EPSG:32733 for UTM zone 33S. If resolution is in meters, use UTM for best results.\n"
